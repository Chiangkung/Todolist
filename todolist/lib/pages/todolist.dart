...
class _TodolistState extends State<Todolist> {
  ...
  Future<void> getTodolist() async {
    List alltodo = [];
    var url = Uri.http('192.168.1.16:8000', '/api/all-todolist');
    var response = await http.get(url);
    //var result = json.decode(response.body); // จะแสดงผลภาษาไทยไม่ได้
    var result = utf8.decode(response.bodyBytes); // เพื่อให้แสดงผลภาษาไทยได้
    print(result);
    setState(() {
